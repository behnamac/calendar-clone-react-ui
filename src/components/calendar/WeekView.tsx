  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="grid grid-cols-8 border-b border-calendar-border">
        {/* Time column header */}
        <div className="py-3 px-4 text-center text-sm font-medium text-muted-foreground bg-muted/30 border-r border-calendar-border">
          Time
        </div>
      ...
      <div className="flex-1 overflow-auto">
        <div className="relative">
          ...
          {timeSlots.map((hour) => (
            ...
            >
              {/* Time label */}
              <div className="p-2 text-sm text-muted-foreground border-r border-calendar-border bg-muted/20 flex items-center justify-center">
                {formatTime(hour)}
              </div>
